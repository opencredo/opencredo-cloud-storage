...
public enum WebExceptionStatus {
	...
	// called,
	// or an unclassifiable error occurred. This is the default value for
	...
	// protocol-level
	// error. For example, an HTTP protocol error such as 401 Access Denied
	// would
	// use this status.
	ProtocolError,
	//
	...
	// occurs
	// when a request is not cacheable and the effective policy prohibits
	// sending
	// the request to the server. You might receive this status if a request
	// method
