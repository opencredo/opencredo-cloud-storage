...
public class JCloudAzureIntegrationTest {
    ...
    private JCloudCredentials credentials = new JCloudCredentials(TestPropertiesAccessor.getAzureDefaultAccountName(),
    ...
    static {
        URL url = JCloudAzureIntegrationTest.class.getResource(TEST_FILE_NAME);
    ...
    @Before
    public void before() {
        template = new JCloudTemplate(CloudProvider.AZUREBLOB, credentials, TestPropertiesAccessor.getDefaultContainerName());
